...
resource "azurerm_dns_a_record" "region-01" {
  ...
  resource_group_name = azurerm_resource_group.main.name
  ttl                 = 300
  records             = [azurerm_public_ip.platform-region-01.ip_address]
}
...
resource "azurerm_dns_a_record" "region-02" {
  ...
  resource_group_name = azurerm_resource_group.main.name
  ttl                 = 300
  records             = [azurerm_public_ip.platform-region-02.ip_address]
}
...
resource "azurerm_dns_a_record" "region-03" {
  ...
  resource_group_name = azurerm_resource_group.main.name
  ttl                 = 300
  records             = [azurerm_public_ip.platform-region-03.ip_address]
}
...
resource "azurerm_dns_a_record" "app" {
  ...
  resource_group_name = azurerm_resource_group.main.name
  ttl                 = 300
  records             = [azurerm_public_ip.platform-region-01.ip_address,azurerm_public_ip.platform-region-02.ip_address, azurerm_public_ip.platform-region-03.ip_address]
}
